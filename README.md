...
This will help with the blind users and the users who have a hard time figuring out where to contact us.



## Usage

![alt text](assets/images/access1.PNG)
...
Hover over hyperlink color change
Hyperlink opens new tab
Email redirect
Sticky bar with text(hyperlink in future)
Company logo
